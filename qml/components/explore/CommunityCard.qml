...
Rectangle {
    ...
    // Compact "1.2k" / "12k" so the footer mono fits raw 4-digit values.
    ...
    // Mock rows carry only kinds; live rows carry the full {kind, value}
    // trail. Lift mocks into the same shape with empty values.
