...
// Two-pane: step list left, inspector right.
Item {
    id: root
    ...
    // path: "enabled" | "on_error" | "action.<field>". Empty value resets.
    ...
    // Flow-control (repeat / conditional / use) lives in `wflow edit`
    // for now since it needs a richer editor than this picker.
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        Row {
                            ...
                            Column {
                                anchors.verticalCenter: parent.verticalCenter
                                // 78px reserved for the hover controls so
                                // layout doesn't shift on mouseover.
                        ...
                        // Stays visible when selected so keyboard users
                        // can see them without hovering.
                        Row {
                            id: ctrlRow
